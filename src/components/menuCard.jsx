...
const MenuCard = ( {post, handleChange}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (datos.nombre == "" || datos.detalle == "" || datos.estado=="" || datos.precio == "" || datos.categoria == ""){
      swal({text: "Los campos no deben estar vacio",
        icon:"error"})
    }
    else{   
      swal({
        ...
        <FormGroup>
          ...
          <ModalFooter>
           <Button color="dark">Modificar</Button>
            <Button color="secondary" onClick={modificarM}>Cerrar</Button>
          </ModalFooter>
